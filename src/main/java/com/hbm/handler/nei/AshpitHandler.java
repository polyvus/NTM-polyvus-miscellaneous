...
public class AshpitHandler extends NEIUniversalHandler {
	...
	public static HashMap getRecipes() {
		...
		ItemStack[] wood = new ItemStack[] {new ItemStack(Blocks.log), new ItemStack(Blocks.log2), new ItemStack(Blocks.planks), new ItemStack(Blocks.sapling), new ItemStack(ModBlocks.laythe_root)};
